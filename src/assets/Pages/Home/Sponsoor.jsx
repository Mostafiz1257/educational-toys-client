    ...
    return (
        <div>
            <div className="w-1/2 mx-auto mb-12 mt-12">
                <h3 className="font-bold text-teal-700 text-5xl text-center" data-aos="fade-right"
                    data-aos-offset="300"
            ...
            <div className='mb-12'>
                <div className=' '>
                    <div className='flex justify-around gap-6 ' data-aos="flip-right">
                    ...
                    <div className='flex justify-around mt-6' data-aos="zoom-in-down">
