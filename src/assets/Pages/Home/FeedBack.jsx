...
const FeedBack = () => {
    return (
        <div>
            ...
            <Marquee speed={100}>
                <div className="flex gap-10 text-teal-700" data-aos="flip-up">
                    <div className="card w-96 h-80 bg-base-100 shadow-xl">
                        <figure className="px-10 pt-10 ">
                            <img src="https://i.ibb.co/PrJY8XX/1.jpg" alt="Shoes" className="rounded-full w-24 h-24 border-4 border-teal-700" />
                        </figure>
